...
(function ($) {
	...
	_initNode = function (setting, level, n, parentNode, isFirstNode, isLastNode, openFlag) {
	    ...
	    if (n.isSelected) {
	       data.addSelectedNode(setting, n);
	    }
	},
	_init = {
	    bind: [_bindEvent],
	...
	view = {
	    ...
	    makeDOMNodeNameBefore: function (html, setting, node) {
	        ...
	        html.push("<a id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level," ",(node.isSelected?consts.node.CURSELECTED:""), "' treeNode", consts.id.A, " onclick=\"", (node.click || ''),
